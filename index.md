...
A permissão de Bluetooth é usada exclusivamente para conectar ao adaptador OBD-II do veículo. Nenhum dado de Bluetooth é enviado a terceiros.

## Compartilhamento

Seus dados não são vendidos nem compartilhados com terceiros. Os únicos processadores envolvidos são o Google Firebase (armazenamento em nuvem e autenticação) e o Sentry (relatórios de falha do app), utilizados apenas para o funcionamento do aplicativo.

## Exclusão de dados

- **Dados locais**: desinstale o aplicativo ou limpe os dados nas configurações do Android.
- **Dados em nuvem e conta**: solicite a exclusão pelo e-mail abaixo, informando o e-mail da conta Google usada no login. A exclusão é concluída em até 30 dias.

## Seus direitos (LGPD)

Nos termos da Lei Geral de Proteção de Dados (Lei 13.709/2018), você pode solicitar acesso, correção ou exclusão dos seus dados a qualquer momento pelo canal de contato abaixo.

## Contato

**E-mail:** maycow.berbert@gmail.com

Esta política pode ser atualizada; alterações relevantes serão indicadas pela data no topo do documento.
